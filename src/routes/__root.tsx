...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A clinical-meets-wellness movement screening app. Get your Movement Score, Movement Age, and a daily 5-minute corrective routine." },
