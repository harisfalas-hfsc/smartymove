...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", href: "/__l5e/assets-v1/f9426666-d5f7-415d-9e73-0062a238fcc9/favicon.png" },
      { rel: "apple-touch-icon", href: "/__l5e/assets-v1/f9426666-d5f7-415d-9e73-0062a238fcc9/favicon.png" },
      {
        rel: "stylesheet",
        href: appCss,
      },
